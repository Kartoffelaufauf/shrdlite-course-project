...
var grammar = {
    ...
    {"name": "command", "symbols": ["drop", "it"], "postprocess": R({command:"drop"})},
    ...
    {"name": "drop$string$1", "symbols": [{"literal":"d"}, {"literal":"r"}, {"literal":"o"}, {"literal":"p"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "drop", "symbols": ["drop$string$1"]},
